<template>
  <div>
    ...
    <div class="share_code">
      ...
      <img src="/static/images/4-4.png" height="212" width="212" class="code_img">
    </div>
    <div class="share_cover" v-show="showHide" @click="showCover">
      <img src="/static/images/5-2.png" class="share_img">
    </div>
  </div>
</template>
...
<style lang="scss">
  ...
  .share_button {
    ...
    background: url(/static/images/4-3.png) no-repeat 0.4rem 0;
  ...
  .share_cover {
    ...
    top: 0;
    left: 0;
    background: url(/static/images/5-1.png) no-repeat;
    background-size: 100% 100%;
    opacity: 0.92;
  }
