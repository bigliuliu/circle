...
<script>
import {fetchArticleDetail, getRemoteArticleCategory, saveUpdateArticle} from '../../api/publish'
...
.publish-video-box .edit-input {
  ...
  background: #E7E7E7 url(../../assets/images/video-cover.png) no-repeat center;
}
