          ...
          <el-form label-position="left" label-width="140px" :rules="rules" ref="publishModal" :model="publishModal">
            ...
            <el-form-item label="封面" v-if="!uploadFile.name">
              <el-radio-group v-model="coverStyle">
                ...
                <el-tooltip content="系统默认选择正文第一张图片作为封面" placement="top" effect="light">(?)</el-tooltip></el-radio>
            ...
            <el-form-item label="分类">
              <el-select v-model="publishModal.category_id">
                <el-option v-for="item in publish_category" :label="item.tag_name" :value="item.id" :key="item.id"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
...
<style type="text/css">
  ...
  .front-cover-cur {
    ...
    width: 12px;
    height: 8px;
    background: #fff url(../../assets/images/icon-line-arrow.png) no-repeat;
  }
  .front-cover-upload {
    float: left;
  }
  .front-cover-wrap {
    ...
    margin-right: 20px;
    position: relative;
    background: #f0f1f3 url(../../assets/images/picutre_add.png) no-repeat center;
  }
  .video-progress-box {
    width: 90%;
  }
  ...
  .video-progress-box .video-progress-bar i {
    width: 16px;
    height: 16px;
    background: url(../../assets/images/tag-close.png) no-repeat;
    /*display: block;*/
    top: 0;
    position: absolute;
    right: -38px;
  ...
  .image-add {
    ...
    cursor: pointer;
    border: 1px solid #E7E7E7;
    background: #F7F7F7 url(../../assets/images/picutre_add.png) no-repeat center;
  }
  .front-cover-tip {
    clear: both;
    font-size: 13px;
  ...
  .video-success>i {
    ...
    margin-top: -24px;
    margin-left: -19px;
    background: url(../../assets/images/video-cover.png) no-repeat;
  }
  ...
  .image-picker>div>i {
    background: url(../../assets/images/add-pic.png) no-repeat;
    width: 70px;
    height: 70px;
    margin: auto;
    display: block;
  ...
  .video-picker>div>i {
    background: url(../../assets/images/add-video.png) no-repeat;
    width: 70px;
    height: 70px;
    margin: auto;
    display: block;
  ...
  .cover-pic-choose {
    ...
    width: 110px;
    display: none;
    background: rgba(0, 0, 0, 0.5) url("../../assets/images/icon-image-choose.png") no-repeat scroll center center;
  }
